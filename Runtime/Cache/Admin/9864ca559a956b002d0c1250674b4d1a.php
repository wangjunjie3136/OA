...
<head>
	...
	<link rel="stylesheet" href="/Thinkphp-1/Public/Admin/css/login.css" />
	<title>移动办公自动化系统</title>
</head>
<body>
	<div id="container">
		<div id="bd">
			<form action="/Thinkphp-1/index.php/Admin/Public/logOk" method="post">
			<div class="login1">
                ...
                <div class="login-input">
                    ...
                    <p class="yzm ue-clear">
                        ...
                        <cite><img src="/Thinkphp-1/index.php/Admin/Public/captcha" onclick="this.src='/Thinkphp-1/index.php/Admin/Public/captcha/t/'+Math.random()"></cite>
					</p>
                </div>
                <div class="login-btn ue-clear">
                	<a href="javascript:;" class="btn" id="btnsubmit">登录</a>
