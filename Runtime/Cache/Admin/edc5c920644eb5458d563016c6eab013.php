      ...
      <div class="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="gongwen">
            ...
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/index.php/Admin/Doc/showList">公文列表</a></li>
              <li><a href="javascript:;" date-src="/index.php/Admin/Doc/add">添加公文</a></li>
            </ul>
          </li>
          <li class="nav-info">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>职员信息</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/index.php/Admin/User/showList">职员列表</a></li>
              <li><a href="javascript:;" date-src="/index.php/Admin/User/add">职员添加</a></li>
            </ul>
          </li>
          <li class="konwledge">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>知识管理</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/index.php/Admin/Knowledge/showList">知识列表</a></li>
              <li><a href="javascript:;" date-src="/index.php/Admin/knowledge/add">添加知识</a></li>
            </ul>
          </li>
          <li class="agency">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>组织结构</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/index.php/Admin/Dept/showList">部门列表</a></li>
              <li><a href="javascript:;" date-src="/index.php/Admin/Dept/add">添加部门</a></li>
            </ul>
          </li>
          <li class="email">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>邮件管理</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/index.php/Admin/Email/send">发送信件</a></li>
              <li><a href="javascript:;" date-src="/index.php/Admin/Email/sendbox">发件箱</a></li>
              <li><a href="javascript:;" date-src="/index.php/Admin/Email/recbox">收件箱</a></li>
            </ul>
          </li>
          <li class="system">
