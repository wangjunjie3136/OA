...
<div class="table-operate ue-clear">
	<a href="/Thinkphp-1/index.php/Admin/Knowledge/add" class="add">添加</a>
...
<div class="table-box">
	<table>
		...
		<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="file"><img src="<?php echo ($vol["thumb"]); ?>"></td>
...
showRemind('input[type=text], textarea','placeholder');
	$(function(){
		$('#btnedit').on('click',function(){
			...
			if(id){
				window.location.href='/Thinkphp-1/index.php/Admin/Knowledge/edit/id/'+id;
			}else{
				alert('请选择');
			}
		});
		$('#btndel').on('click',function(){
			...
			if(ids){
				window.location.href='/Thinkphp-1/index.php/Admin/Knowledge/del/ids/'+ids;
			}else{
				alert('请选择');
			}
		});
